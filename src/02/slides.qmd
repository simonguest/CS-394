...
{{< embed notebooks/instruction-tuned.ipynb#base-model echo=true outputs=false >}}

## Putting This Together

{{< embed notebooks/instruction-tuned.ipynb#base-model >}}

## Putting This Together

{{< embed notebooks/instruction-tuned.ipynb#it-model echo=true outputs=false >}}

## Putting This Together

{{< embed notebooks/instruction-tuned.ipynb#it-model >}}
...
Exploring [Qwen/Qwen2.5-0.5B-Instruct](https://huggingface.co/Qwen/Qwen2.5-0.5B-Instruct){.external target="_blank"} on Hugging Face
