...
- **Option 1**: The trickiest part is getting the native libraries loaded correctly. Look at the example project in src/code/05/unity and check the [LLamaSharp documentation](https://github.com/SciSharp/LLamaSharp){.external target="_blank"} for platform-specific setup.
