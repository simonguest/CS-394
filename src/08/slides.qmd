...
- Technical Poisioning/Watermarking:
  - Add adversarial pertubations ("defensive" and "poisioning") to images to degrade model training
    ...
    - Lowest strengths barely noticable side-by-side
...
- [Jason Allen](https://en.wikipedia.org/wiki/Th%C3%A9%C3%A2tre_D%27op%C3%A9ra_Spatial){.external target="_blank"}: 
  - A Colorado-based artist who became widely known in 2022 after winning first place in the digital art category of the Colorado State Fair (with a piece created using an AI image generator)
