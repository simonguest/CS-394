...
- **Recipe Assistant** -- Generate cooking instructions that always follow a structured format (ingredients, steps, tips) and adapt to dietary restrictions (vegan, gluten-free, etc.)
...
- Smaller datasets with high quality are better than large datasets with noise. Start with 50 training examples and review them before scaling up
- Use structured outputs (Pydantic models) to keep your generated data consistent, as demonstrated in the notebook
- Be careful with the model you select to generate the data (as hundreds or thousands of calls will run up charges on paid models)
