...
- [This week's assignment!](https://simonguest.github.io/CS-394/src/01/assignment.html){.external target="_blank"}
- New to Python?
  - [Learn Python with Jupyter](https://www.learnpythonwithjupyter.com/){.external target="_blank"}
- Next Week's Topics
