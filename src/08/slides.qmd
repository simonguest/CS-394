...
- [Sydney](https://en.wikipedia.org/wiki/Sydney_(Microsoft)){.external target="_blank"}: 
  ...
  - Following negative media attention, Microsoft "tamed" the AI, removing the persona and limiting the length and scope of chat sessions

## Examples

- [Chevrolet of Watsonville](https://cybernews.com/ai-news/chevrolet-dealership-chatbot-hack/){.external target="_blank"}: 
...
TBD: Screenshot of Chat

## Examples

- [Air Canada](https://arstechnica.com/tech-policy/2024/02/air-canada-must-honor-refund-policy-invented-by-airlines-chatbot/){.external target="_blank"}: 
...
- [DAN](https://gist.github.com/coolaj86/6f4f7b30129b0251f61fa7baaa881516){.external target="_blank"}: 
...
- [Fiction Framing Attacks](https://www.cyberark.com/resources/threat-research-blog/operation-grandma-a-tale-of-llm-chatbot-vulnerability){.external target="_blank"}:
...
- [Adversarial Optimization](https://neurips.cc/virtual/2025/loc/san-diego/poster/116299){.external target="_blank"}: 
  - By appending carefully optimized nonsense suffixes to prompts, researcher have found they could consistently bypass safeguards across models (similar approach to Nightshade)
...
- [AI-generated Malware](https://latesthackingnews.com/2025/09/12/from-vibe-coding-to-vibe-hacking-claude-ai-abused-to-build-ransomware){.external target="_blank"}:
...
- [OpenClaw Goes Rogue](https://techcrunch.com/2026/02/23/a-meta-ai-security-researcher-said-an-openclaw-agent-ran-amok-on-her-inbox){.external target="_blank"}: 
...
- [Anthropic vs. Department of War](https://www.anthropic.com/news/statement-department-of-war){.external target="_blank"}: 
