...
- Two ways to interact with a local GGUF model:
- Use llama.cpp to serve the model via a local web server
  - Easier to interact with, but the overhead of a local web server
- Use llama.cpp bindings
  - Trickier to get setup, but much more native
...
## Using llama.cpp in Unreal Engine
...
build/libllama.a (or llama.lib on Windows) - main library
build/libggml.a (or ggml.lib) - tensor operations library
Header files in include/ directory

Create a plug-in in Unreal

mkdir -p Plugins/LlamaCppPlugin/Source/ThirdParty/llama.cpp
...
- llama.cpp bindings as a major topic (unity and unreal examples)
- WASM example using wllama and MLC
